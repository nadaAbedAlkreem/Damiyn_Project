						...
						<div class="main-header-left ">
							<div class="responsive-logo">
								...
								<a href="index.html" class="header-logo">
									<img src="{{url('assets/img/brand/logo.png')}}" class="logo-1" alt="logo">
									<img src="{{url('assets/img/brand/logo-white.png')}}" class="dark-logo-1" alt="logo">
								</a>
							</div>
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item  navbar-nav-right ms-auto">
											...
											<!-- <div class="dropdown  nav-item countries">
												...
												<div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow">
													<a href="javascript:void(0);" class="dropdown-item d-flex ">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{url('assets/img/flag-imgs/french_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
															<span class="mt-2">French</span>
														</div>
													</a>
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{url('assets/img/flag-imgs/germany_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
															<span class="mt-2">Germany</span>
														</div>
													</a>
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{url('assets/img/flag-imgs/italy_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
													...
													<a href="javascript:void(0);" class="dropdown-item d-flex">
														<span class="avatar me-1 align-self-center bg-transparent"><img src="{{url('assets/img/flag-imgs/spain_flag.jpg')}}" alt="img"></span>
														<div class="d-flex">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link">
											<a class="profile-user d-flex" href=""><img alt="" src="{{url('assets/images/user/user-thumb.jpg')}}"></a>
											<div class="dropdown-menu">
												<div class="main-header-profile bg-primary p-3">
													<div class="d-flex wd-100p">
														<div class="main-img-user"><img alt=""src="{{url('assets/images/user/user-thumb.jpg')}}" > </div>
												...
												<a class="dropdown-item" href="chat.html"><i class="bx bx-envelope"></i>Messages</a> -->
 												<a class="dropdown-item" href="{{route('admin.logout')}}"><i class="bx bx-log-out"></i> Sign Out</a>
											</div>
										</li>
									</ul>
								</div>
